...
glm::vec3 lightPos = glm::vec3(1.2f, 1.0f, 2.0f), lightColor = glm::vec3(1.0f, 0.75f, 1.0f);
...
int main() {
    ...
    Shader objShader("../src/13_materials/shader/obj.vs.glsl", "../src/13_materials/shader/obj.fs.glsl"), // 物体渲染
    lightShader("../src/13_materials/shader/light.vs.glsl", "../src/13_materials/shader/light.fs.glsl"); // 光源渲染
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        // 观察到物体的颜色 = 光的颜色 * 物体本身的颜色
        brightness = abs(cos(glfwGetTime() * 4.0f));
        lightColor.z = abs(sin(glfwGetTime() * 2.0f));
